...
Scenario: A simple Person node can be created
  ...
  And fill in "First Name" with "Ralphie"
  And fill in "Last Name" with "Buffalo"
  And I fill in "edit-field-person-photo-und-0-alt" with "Ralphie Portrait"
  And I attach the file "ralphieMtns.jpg" to "edit-field-person-photo-und-0-upload"
  When I press "Save"
  Then I should see "Person Ralphie Buffalo has been created."
