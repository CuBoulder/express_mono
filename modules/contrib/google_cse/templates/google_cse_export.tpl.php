...
<CustomSearchEngine id="<?php print $node['cse_id']?>" creator="<?php print $node['cse_creator']?>" cx_id="<?php print $node['cse_id']?>:<?php print $node['cse_creator']?>" language="en" encoding="UTF-8" enable_suggest="true" autocompletions="true">
    ...
    <LookAndFeel nonprofit="true" show_ads_for_nonprofits="false" element_layout="7" theme="7" custom_theme="true" text_font="Arial, sans-serif" url_length="full" element_branding="show" enable_cse_thumbnail="false" promotion_url_length="full" ads_layout="1">
        <Logo />
