...
class CUWebComponent extends BeanPlugin {
  ...
  /* Set default options if the user is editing a bean. The data for the available web components are in a Google Spreadsheet.
   *
   ...
   * Displays the bean.
   *
   * @return {array} returns the contetnt that will be injected in the page
   */
